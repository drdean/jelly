defmodule JellyBoard.IntegrationCase do
  use ExUnit.CaseTemplate
  use Hound.Helpers
  import JellyBoard.Factory

  alias JellyBoard.{Repo, User, Board, UserBoard}
  ...
  using do
    quote do
      ...
      import JellyBoard.Router.Helpers
      import JellyBoard.Factory
      import JellyBoard.IntegrationCase

      alias JellyBoard.Repo

      # The default endpoint for testing
      @endpoint JellyBoard.Endpoint
  ...
  setup tags do
    unless tags[:async] do
      Ecto.Adapters.SQL.restart_test_transaction(JellyBoard.Repo, [])
    end
