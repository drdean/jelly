defmodule JellyBoard.BoardChannel do
  @moduledoc """
  Board channel
  """
  ...
  alias JellyBoard.{User, Board, UserBoard, List, Card, Comment, CardMember}
  alias JellyBoard.BoardChannel.Monitor
    ...
    try do
      ...
      case Repo.insert(changeset) do
        {:ok, _board_user} ->
          ...
          JellyBoard.Endpoint.broadcast_from! self(), "users:#{user.id}", "boards:add", %{board: board}
