defmodule JellyBoard.Board do
  use JellyBoard.Web, :model

  alias __MODULE__
  alias JellyBoard.{Repo, Permalink, List, Comment, Card, UserBoard, User}
...
defimpl Poison.Encoder, for: JellyBoard.Board do
  def encode(model, options) do
    model
    |> Map.take([:name, :lists, :user, :members])
    |> Map.put(:id, JellyBoard.Board.slug_id(model))
